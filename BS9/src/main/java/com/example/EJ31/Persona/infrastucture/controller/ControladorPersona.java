...
import com.example.EJ31.Persona.aplication.port.*;
...
public class ControladorPersona {
    ...
    @GetMapping("/feign/{id}")
    ResponseEntity<ProfesorOutputDTO> getProfesorFeign(@PathVariable int id){
        try{
            ResponseEntity<ProfesorOutputDTO> responseEntity=feignPort.callServer(id);
